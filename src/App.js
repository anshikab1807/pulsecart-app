...
const ProductDetailPage = ({ product, addToCart, onNavigateToHome, onNavigateToCategories, theme }) => {
  if (!product) {
    return (
      <div className={`min-h-screen flex items-center justify-center ${theme === 'dark' ? 'bg-gray-800 text-gray-100' : (theme === 'eyeFriendly' ? 'bg-yellow-50' : 'bg-gray-50 text-gray-800')}`}>
...
const App = () => {
  ...
  const [isMoreOptionsOpen, setIsMoreOptionsOpen] = useState(false); // New state for More Options dropdown

  // Ref for the More Options dropdown to close on outside click
  ...
  const navigateTo = (page, product = null) => {
    ...
    setIsMoreOptionsOpen(false); // Close dropdown on navigation
  };
  ...
  // Effect to close More Options dropdown when clicking outside
  useEffect(() => {
    ...
    <div className={`min-h-screen font-sans ${getOverallThemeClasses()}`}>
      ...
      <header className={`${getHeaderFooterBg()} shadow-sm py-4 px-6 md:px-12 flex items-center justify-between sticky top-0 z-50 rounded-b-lg`}>
        <div className="flex items-center space-x-4">
          ...
          <nav className="hidden md:flex items-center space-x-6"> {/* Added items-center */}
            {isLoggedIn && (
              <>
                ...
                <div className="relative" ref={moreOptionsRef}> {/* Added ref here */}
                  <button
                    onClick={() => setIsMoreOptionsOpen(!isMoreOptionsOpen)}
                    className={`px-3 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-1 transition-colors duration-200`}
                  >
                    More Options <ChevronRight size={18} className={`transform ${isMoreOptionsOpen ? 'rotate-90' : ''} transition-transform duration-200`} />
                  </button>
                  {isMoreOptionsOpen && (
                    <div className={`absolute top-full left-0 mt-2 w-48 ${getHeaderFooterBg()} rounded-md shadow-lg py-1 z-20 border ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
                      <button onClick={() => navigateTo('arTryOn')} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        <Camera size={18} /> Try AR
                      </button>
                      <button onClick={() => navigateTo('seller')} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        <Briefcase size={18} /> Become a Seller
                      </button>
                      <button onClick={() => setIsChatbotOpen(true)} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        <MessageSquare size={18} /> Chat with AI
                      </button>
                      <a href="#contact-footer" onClick={() => navigateTo('home')} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        <Phone size={18} /> Contact
                      </a>

                      <hr className={`my-1 ${theme === 'dark' ? 'border-gray-600' : 'border-gray-200'}`} /> {/* Separator */}

                      {/* Added new options */}
                      <button onClick={() => navigateTo('categories')} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        <Store size={18} /> Shop
                      </button>
                      <button onClick={toggleDarkMode} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        {theme === 'dark' ? <Sun size={18} /> : <Moon size={18} />} Dark Mode
                      </button>
                      <button onClick={toggleEyeFriendlyMode} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        <Sun size={18} /> Eye-Friendly Mode
                      </button>
                      <button onClick={handleLogout} className={`w-full text-left px-4 py-2 rounded-md ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} flex items-center gap-2 transition-colors duration-200`}>
                        <User size={18} /> Logout
                      </button>
                    </div>
                  )}
        ...
        <div className="flex items-center space-x-4">
          {/* Removed theme toggles from main header */}
          {isLoggedIn && (
          ...
          {/* Removed Login/Logout from main header, now only in More Options or as a standalone button if not logged in */}
          {!isLoggedIn && (
            <button onClick={() => navigateTo('login')} className={`px-3 py-2 rounded-md flex items-center gap-1 ${getHeaderFooterText()} ${getHeaderLinkHoverClass()} transition-colors duration-200`}>
